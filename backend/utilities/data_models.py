...
class HubRequest(BaseModel):
    ...
    do_sample: Optional[int] = None
    temperature: Optional[float] = None
    top_k: Optional[int] = None
    top_p: Optional[float] = None
    repetition_penalty: Optional[float] = None

# https://github.com/petals-infra/chat.petals.dev?tab=readme-ov-file#http-api-apiv1
class PetalsRequest(BaseModel):
    model: str
